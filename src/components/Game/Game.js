...
function Game() {
  ...
  {isHappy && <HappyBanner guessesCount={guessesCount} setAnswer={setAnswer} setGuesses={setGuesses}/>}
  {isSad && <SadBanner answer={answer} setAnswer={setAnswer} setGuesses={setGuesses}/>}
